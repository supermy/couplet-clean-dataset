# 2022-12-09 GPT2格式CLM:[CLS]line1[SEP][CLS]line2[SEP]
...
sed -i -e "s/^/[CLS]&/g;s/$/&[SEP]/g;s/@/[SEP][CLS]/g" couplet-train.txt
sed -i -e "s/^/[CLS]&/g;s/$/&[SEP]/g;s/@/[SEP][CLS]/g" couplet-test.txt
